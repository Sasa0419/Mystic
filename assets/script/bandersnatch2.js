...
const niveaux = [
  {
    ...
    question: "Comment ciblez-vous le dernier élément enfant d'un élément parent en CSS ?",
    choix: [
      { texte: ":nth-child(last)", correct: false },
      { texte: ":last-child", correct: true },
      { texte: ":child(last)", correct: false }
    ]
  }
