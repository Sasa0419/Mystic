...
<head>
    ...
    <script src="assets/script/enigme1.js" defer></script>
...
<div class="ligne">
        <div class="fenetre">
        <div class="display">
            <p class="p">Niveau 1</p>
            <button class="btn1 test-event"> x </button>
            <button class="btn1 test-eventt"> □ </button>
            <button class="btn1 test-eventt"> _ </button>
        </div>

    <p class="enigme">Question : Comment modifier le contenu texte d'un élément HTML en JavaScript ?</p>
