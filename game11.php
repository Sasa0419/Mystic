...
<head>
    ...
    <script src="assets/script/enigme4.js" defer></script>
...
<div class="ligne">
        <div class="fenetre">
        <div class="display">
            <p class="p">Niveau 11</p>
            <button class="btn1 test-event"> x </button>
            <button class="btn1 test-eventt"> □ </button>
            <button class="btn1 test-eventt"> _ </button>
        </div>
    <p class="enigme">Question : Quel opérateur en JavaScript compare les valeurs et les types de données ?</p>
