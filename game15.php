...
<head>
    ...
    <script src="assets/script/enigme5.js" defer></script>
...
<div class="ligne">
        <div class="fenetre">
        <div class="display">
            <p class="p">Niveau 15</p>
            <button class="btn1 test-event"> x </button>
            <button class="btn1 test-eventt"> □ </button>
            <button class="btn1 test-eventt"> _ </button>
        </div>
    <p class="enigme">Question : Comment ajouter un nouvel élément HTML à une page en utilisant le DOM ?</p>
