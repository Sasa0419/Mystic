...
<head>
    ...
    <link rel="stylesheet" href="assets/styles/pop.css">
    <script src="assets/script/scriptPOP.js" defer></script>
...
<div class="fenetre">
        <div class="display">
                <p class="p">Niveau 6</p>
                <button class="btn1 test-event" id="bouton-apparition"> x </button>
