...
<head>
    ...
    <script src="assets/script/enigme3.js" defer></script>
...
<div class="ligne">
        ...
        <p class="enigme">Question : "Quel mécanisme PHP permet de stocker des données côté serveur ?"</p>
