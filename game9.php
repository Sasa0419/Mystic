...
<head>
    ...
    <script src="assets/script/scriptQ.js" defer></script>
...
<div class="ligne">
        <div class="binaire">
        <div class="display">
            <p class="p">Niveau 9</p>
            <button class="btn1 test-event"> x </button>
            <button class="btn1 test-eventt"> □ </button>
            <button class="btn1 test-eventt"> _ </button>
        </div>

        <p class="enigme">Question : 01101000 01100101 01101100 01101100 01101111 00100000 01110111 01101111 01110010 01101100 01100100</h3>
        <div >
            <input type="text"  id="reponseUtilisateur"  placeholder="Votre réponse">
        </div>
            <button id="verifierButton" class="verifier">Vérifier</button>
